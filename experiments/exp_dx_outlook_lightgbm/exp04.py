"""
実験ID: exp04
実験名: LightGBM品詞アブレーション（名詞＋動詞）
著者: Codex

目的・仮説:
- 名詞に動詞を加え、企業の取組対象だけでなく行動や方針も表現する。
- exp03との差から動詞の追加価値を検証する。
...
出力:
- experiments/exp_dx_outlook_lightgbm/results/exp04/feature_importance.png
- experiments/exp_dx_outlook_lightgbm/results/exp04/f1_scores.png
...
EXPERIMENT_ID = "exp04"
EXPERIMENT_NAME = "LightGBM品詞アブレーション（名詞＋動詞）"
