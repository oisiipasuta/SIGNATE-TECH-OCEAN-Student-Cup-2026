"""
実験ID: exp06
実験名: LightGBM品詞アブレーション（名詞＋動詞＋形容詞・形状詞＋副詞）
著者: Codex

目的・仮説:
- exp05の品詞に副詞を加え、行動の強さ・速度感も表現する。
- exp05との差から副詞の追加価値を検証する。
...
出力:
- experiments/exp_dx_outlook_lightgbm/results/exp06/feature_importance.png
- experiments/exp_dx_outlook_lightgbm/results/exp06/f1_scores.png
...
EXPERIMENT_ID = "exp06"
EXPERIMENT_NAME = "LightGBM品詞アブレーション（名詞＋動詞＋形容詞・形状詞＋副詞）"
