"""
実験ID: exp14
実験名: n-gram品詞累積比較（名詞＋動詞）
著者: Codex

目的・仮説:
- exp13の名詞に動詞を追加し、対象と行動のbigramを含む表現が性能を改善するか調べる。
...
出力:
- experiments/exp_dx_outlook_lightgbm/results/exp14/feature_importance.png
- experiments/exp_dx_outlook_lightgbm/results/exp14/f1_scores.png
- CSV、JSON、予測値、submissionは出力しない。

実行結果（2026-08-10実行）:
- 入力特徴量数: 1、TF-IDF語彙数: 53842, 53486, 53589, 53325, 53454
- SVD後特徴量数: 各fold 30、除外した全欠損特徴量: なし
- fold threshold: 0.385, 0.305, 0.285, 0.345, 0.435
- fold F1: 0.5682, 0.5161, 0.5556, 0.4771, 0.5316
- fold F1 mean ± std: 0.5297 ± 0.0320
- nested OOF F1: 0.5254、最終threshold: 0.3510
"""
...
EXPERIMENT_ID = "exp14"
EXPERIMENT_NAME = "n-gram品詞累積比較（名詞＋動詞）"
PARTS_OF_SPEECH = ("名詞", "動詞")
NGRAM_RANGE = (1, 2)
FEATURE_LABEL = "名詞＋動詞・word unigram＋bigram・SVD 30"
