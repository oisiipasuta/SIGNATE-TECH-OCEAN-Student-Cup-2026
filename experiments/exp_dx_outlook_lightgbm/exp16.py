"""
実験ID: exp16
実験名: n-gram品詞累積比較（名詞＋動詞＋形容詞・形状詞＋副詞）
著者: Codex

目的・仮説:
- exp15に副詞を追加し、程度・頻度・速度を含むn-gramの追加価値を調べる。
...
出力:
- experiments/exp_dx_outlook_lightgbm/results/exp16/feature_importance.png
- experiments/exp_dx_outlook_lightgbm/results/exp16/f1_scores.png
...
EXPERIMENT_ID = "exp16"
EXPERIMENT_NAME = "n-gram品詞累積比較（名詞＋動詞＋形容詞・形状詞＋副詞）"
PARTS_OF_SPEECH = ("名詞", "動詞", "形容詞", "形状詞", "副詞")
NGRAM_RANGE = (1, 2)
FEATURE_LABEL = "名詞＋動詞＋形容詞・形状詞＋副詞・word unigram＋bigram・SVD 30"
