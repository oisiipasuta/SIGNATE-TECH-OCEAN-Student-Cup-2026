"""exp_mix/exp05（all_features_v5）のSIGNATE提出用CSVを生成する。"""
...
from experiments.exp_mix.exp05 import (
    TARGET_COLUMN,
    fit_fold_model,
...
OUTPUT_PATH = BASE_DIR / "submission5.csv"

# exp_mix/exp05のnested CVで得たouter-fold閾値の平均。
THRESHOLD = 0.2470
...
def create_submission(
    ...
    """全学習データでexp05を再学習し、提出形式の予測を保存する。"""
