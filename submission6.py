"""exp_mix/exp06（all_features_v6）のSIGNATE提出用CSVを生成する。"""
...
from experiments.exp_mix.exp06 import (
    TARGET_COLUMN,
    fit_fold_model,
...
OUTPUT_PATH = BASE_DIR / "submission6.csv"

# exp_mix/exp06のnested CVで得たouter-fold閾値の平均。
THRESHOLD = 0.2460
...
def create_submission(
    ...
    """全学習データでexp06を再学習し、提出形式の予測を保存する。"""
    ...
    fitted = fit_fold_model(train.drop(columns=[TARGET_COLUMN]), y_train)
